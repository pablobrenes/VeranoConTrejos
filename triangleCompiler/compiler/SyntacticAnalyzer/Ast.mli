...
and astExpression =
  ...
  | CallExpression                  of astInfo * astIdentifier *
                                       astActualParameterSequence
  | IfExpression                    of astInfo * astExpression * astExpression *
                                       astExpression
  | LetExpression                   of astInfo * astDeclaration * astExpression
  | UnaryExpression                 of astInfo * astOperator * astExpression
  | BinaryExpression                of astInfo * astExpression * astOperator *
                                       astExpression
...
and astArrayAggregate =
    SingleArrayAggregate            of astInfo * astExpression
  | MultipleArrayAggregate          of astInfo * astExpression *
                                       astArrayAggregate
  | CheckedArrayAggregate           of astArrayAggregate * int

and astRecordAggregate =
    SingleRecordAggregate           of astInfo * astIdentifier * astExpression
  | MultipleRecordAggregate         of astInfo * astIdentifier * astExpression *
                                       astRecordAggregate
  | CheckedRecordAggregate          of astRecordAggregate * astFieldTypeDenoter

and astVname =
    SimpleVname                     of astInfo * astIdentifier
  | DotVname                        of astInfo * astVname * astIdentifier
  | SubscriptVname                  of astInfo * astVname * astExpression
  | CheckedVname                    of astVname * bool * bool * int *
                                       astTypeDenoter
...
and astDeclaration =
  ...
  | ProcDeclaration                 of astInfo * astIdentifier *
                                       astFormalParameterSequence * astCommand
  | FuncDeclaration                 of astInfo * astIdentifier *
                                       astFormalParameterSequence *
                                       astTypeDenoter * astExpression
  | TypeDeclaration                 of astInfo * astIdentifier * astTypeDenoter
  | UnaryOperatorDeclaration        of astInfo * astOperator * astTypeDenoter *
                                       astTypeDenoter
  | BinaryOperatorDeclaration       of astInfo * astOperator * astTypeDenoter *
...
and astFormalParameter =
    ConstFormalParameter            of astInfo * astIdentifier * astTypeDenoter
  | VarFormalParameter              of astInfo * astIdentifier * astTypeDenoter
  | ProcFormalParameter             of astInfo * astIdentifier *
                                       astFormalParameterSequence
  | FuncFormalParameter             of astInfo * astIdentifier *
                                       astFormalParameterSequence *
                                       astTypeDenoter

and astActualParameter =
    ConstActualParameter            of astInfo * astExpression
...
and astFormalParameterSequence =
    EmptyFormalParameterSequence    of astInfo
  | SingleFormalParameterSequence   of astInfo * astFormalParameter
  | MultipleFormalParameterSequence of astInfo * astFormalParameter *
                                       astFormalParameterSequence

and astActualParameterSequence =
    EmptyActualParameterSequence    of astInfo
  | SingleActualParameterSequence   of astInfo * astActualParameter
  | MultipleActualParameterSequence of astInfo * astActualParameter *
                                       astActualParameterSequence
...
and astTypeDenoter =
  ...
  | ArrayTypeDenoter                of astInfo * astIntegerLiteral *
                                       astTypeDenoter
...
and astFieldTypeDenoter =
    SingleFieldTypeDenoter          of astInfo * astIdentifier * astTypeDenoter
  | MultipleFieldTypeDenoter        of astInfo * astIdentifier *
                                       astTypeDenoter * astFieldTypeDenoter

and astIntegerLiteral =
    IntegerLiteral                  of astInfo * string

and astCharacterLiteral =
    CharacterLiteral                of astInfo * string

and astIdentifier =
    Identifier                      of astInfo * string
  | CheckedIdentifier               of astIdentifier * astDeclaration ref

and astOperator =
    Operator                        of astInfo * string
